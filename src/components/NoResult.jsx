...
const NoResult = () => {
  ...
  <svg className="mx-auto" xmlns="http://www.w3.org/2000/svg" width={168} height={164} viewBox="0 0 168 164" fill="none">
    ...
    <path d="M152.214 130.643L149.535 127.964M150.071 119.928C150.071 115.195 146.234 111.357 141.5 111.357C136.766 111.357 132.928 115.195 132.928 119.928C132.928 124.662 136.766 128.5 141.5 128.5C143.858 128.5 145.993 127.548 147.543 126.007C149.104 124.455 150.071 122.305 150.071 119.928Z" stroke="#4F46E5" strokeWidth="1.6" strokeLinecap="round" />
    <defs>
      <filter id="filter0_d_14133_736" x="1.99988" y={0} width={164} height={164} filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
  ...
  <div>
    <h2 className="text-center text-black text-xl font-semibold leading-loose pb-2">No Result Match</h2>
